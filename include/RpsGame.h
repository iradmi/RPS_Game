...
private:
	...
	enum class Player : uint8_t { User,
                                  PC,
                                  None };
	...
	void    promptAndValidateNumberOfRoundsInput();
	...
	/// Start the game; delay of @see(_ROUNDS_DELAY) is added between rounds for more pleasing user experience
